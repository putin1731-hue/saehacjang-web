      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-[2.5rem] shadow-2xl border border-[#E9DCC9] overflow-hidden">
          ...
          <div className="p-8 md:p-12">
            {/* [수정] 성경 원본 글자 크기 및 박스 패딩 최적화 */}
            <div className="mb-6 text-center py-10 bg-[#F9F7F2]/60 rounded-[2rem] border border-[#E9DCC9]/40 shadow-inner">
              <p className="text-xl md:text-2xl font-serif text-[#3A3A3A] leading-[1.7] px-8 select-none pointer-events-none font-medium opacity-95">
                {currentBible.t}
              </p>
            </div>
            
            <div className="relative">
              {/* [수정] 입력창 높이 및 글자 크기 최적화 */}
              <textarea
                value={userInput}
                ...
                className={`w-full h-32 p-6 rounded-[1.5rem] border-2 text-lg font-serif focus:outline-none transition-all duration-500 
              ...
              <div className="mt-2 min-h-[20px] text-center">
                {isVerseComplete && <p className="text-[#C5A059] text-xs font-bold animate-bounce tracking-tight">✨ 은혜로운 기록입니다. 계속해서 다음 절로 나아가세요.</p>}
              </div>
            </div>

            <div className="mt-6 flex items-center justify-center gap-6 border-b border-[#E9DCC9] pb-10">
            ...
            <div className="mt-10 p-8 bg-[#F9F7F2]/80 rounded-[2.5rem] border border-[#E9DCC9] relative overflow-hidden">
              ...
              <div className="flex flex-col md:flex-row items-center gap-3">
                ...
                <div className="w-full md:w-[200px]">
                  <input 
                    type="text" placeholder="연락처" value={nextPhone}
